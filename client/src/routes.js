...
import RegisterPage from "./sections/auth/register/RegisterPage"; // Import the RegisterPage component
...
export default function Router() {
  ...
  const adminRoutes = useRoutes([
    ...
    { path: "register", element: <RegisterPage /> }, // Add register route here
